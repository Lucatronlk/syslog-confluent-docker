...
#
# syslog.py --host 192.168.1.100 --port 514 --file logs/syslog.log --count 10
#

# Send 10 messages every 30 seconds:
#
# syslog.py --host 192.168.1.100 --port 514 --file logs/syslog.log --count 10 --sleep 30
...
# """
hostname = 'test-syslog-host'
domain_name = 'syslog.test.'
